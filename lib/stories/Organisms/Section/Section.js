Drupal.behaviors.name155={attach:function attach(){function a(a){// Migrate to new heading tags.
...
if(!b.classList.contains("custom")){var c=b.querySelectorAll(".accordion, .action-list, .body, .cards, .steps, .teaser-list, .profile-cards, .view-results .content, .tabs");if(c){// Determine if section heading exists.
var d=b.querySelector(".section__content > .container > .section__header"),e=d.querySelector("h1, h2")?d.querySelector("h1, h2").tagName:null;e&&"H1"!==e&&(a(c),b.classList.add("custom"))}}})}// Adjust for cards support.
