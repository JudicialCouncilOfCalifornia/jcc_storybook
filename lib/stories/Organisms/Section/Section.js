Drupal.behaviors.name927={attach:function attach(){function a(a){// Migrate to new heading tags.
a.forEach(function(a){var b=a.querySelectorAll("h1, h2, h3, h4, h5, h6");b.forEach(function(a){var b=a.tagName,c=+b.charAt(1),d=a.className;if(!d.includes("heading-adjusted")){var e=document.createElement("h"+(c+1));// Migrate text & replace original heading.
for(e.classList.add("heading-adjusted"),d&&e.classList.add(d);a.firstChild;)e.appendChild(a.firstChild);a.parentNode.replaceChild(e,a)}})})}function b(a,b){// Extend cards component styling - see Section.css.
