Drupal.behaviors.name579={attach:function attach(){function a(a){// Migrate to new heading tags.
...
if(!b.classList.contains("headings-adjusted")){var c=b.querySelectorAll(".accordion, .action-list, .body, .cards, .steps, .teaser-list, .profile-cards, .view-results .content, .tabs, .list");if(c){// Determine if section heading exists.
var d,e=b.querySelector(".section__content > .container > .section__header");e&&(d=e.querySelector("h1, h2")?e.querySelector("h1, h2").tagName:null),d&&"H1"!==d&&(a(c),b.classList.add("headings-adjusted"))}}})}// Adjust for cards support.
