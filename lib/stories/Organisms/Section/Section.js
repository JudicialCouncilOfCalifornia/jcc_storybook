Drupal.behaviors.name561={attach:function attach(){function a(a){// Migrate to new heading tags.
...
var d=b.querySelector(".section__content > .container > .section__header"),e=null!==d&&d.querySelector("h1, h2")?d.querySelector("h1, h2").tagName:null;e&&"H1"!==e&&(a(c),b.classList.add("headings-adjusted"))}}})}// Adjust for cards support.
