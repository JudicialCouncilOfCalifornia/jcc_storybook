...
export default {
  ...
  argTypes: {
    ...
    card_variant: {
      ...
      table: {defaultValue: {summary: 'default'}},
      control: { type: 'select' },
      options: ['card--default', 'card--media-left', 'card--media-right', 'card--bordered-center', 'card--overlay', 'card--striped'],
    },
    sub_component_layout: {
      description: "Sets the layout type for sub component items.",
      table: {defaultValue: {summary: 'switcher'}},
      control: { type: 'select' },
      options: ['center', 'cluster', 'grid', 'reel', 'with-sidebar', 'stack', 'switcher', 'flex flex--75-25', 'flex flex--70-30', 'flex flex--60-40'],
    },
    // center, stack
    align_items: {
    ...
    // center, switcher
    measure: {
      description: "Sets the *measure* or ideal content width or switching point for **Center** or **Switcher**.",
      table: {defaultValue: {summary: '60'}},
      control: { type: 'number' },
    },
    // cluster, grid, reel, stack, switcher
    gap: {
      description: "Sets the *gap* size from our *modular scale* for **Cluster, Grid, Reel, Stack** and **Switcher**.",
      table: {defaultValue: {summary: '--s1'}},
      control: { type: 'select' },
      options: ['--s-5', '--s-4', '--s-3', '--s-2', '--s-1', '--s0', '--s1', '--s2', '--s3', '--s4', '--s5'],
    },
    // grid
    grid_min_width: {
    ...
    // with-sidebar
    sidebar_direction: {
      description: "Sets the direction for the **Sidebar** layout where the default *row* is sidebar on the left and *row-reverse* is sidebar on the right.",
