...
import data from './EmailSingup.data';
import EmailSingup from './EmailSingup.twig';
import './EmailSingup.css';
// import './EmailSingup.js';
...
export default {
  ...
  argTypes: {
    ...
    variant: {
      description: "EmailSingup variant.",
...
const Template = ({ ...args }) => {
  return EmailSingup({ ...args });
};

// Bind the Default component variant for this component.
export const Default = Template.bind({});
// Data comes from the EmailSingup.data.js file.
